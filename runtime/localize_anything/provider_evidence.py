...
def build_provider_execution_policy(
    ...
    *,
    ...
    result = {
        ...
        "status": status,
        "execution_mode": mode,
        "provider_id": str(payload.get("provider_id") or payload.get("provider_name") or payload.get("provider") or ""),
        "provider_name": str(payload.get("provider_name") or payload.get("provider") or ""),
        "provider_profile": str(payload.get("provider_profile") or payload.get("provider_profile_id") or payload.get("profile_id") or ""),
...
def build_provider_handoff_request(
    ...
    *,
    ...
    result = {
        ...
        "status": status,
        "execution_mode": mode,
        "provider_id": str(payload.get("provider_id") or payload.get("provider_name") or policy.get("provider_id") or policy.get("provider_name") or ""),
        "provider_name": str(payload.get("provider_name") or policy.get("provider_name") or ""),
        "provider_profile": str(payload.get("provider_profile") or payload.get("provider_profile_id") or payload.get("profile_id") or policy.get("provider_profile") or ""),
        ...
        "privacy_mode": str(payload.get("privacy_mode") or payload.get("privacy_policy") or ""),
        "source_hash": str(payload.get("source_hash") or payload.get("source_content_hash") or ""),
