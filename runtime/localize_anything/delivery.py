...
from .document_evidence_queue import (
...
from .workbench_action import (
    WORKBENCH_ACTION_LOG_JSONL,
    WORKBENCH_ACTION_RESULT_JSON,
    workbench_action_asset_paths,
)
...
from .provider_smoke_closure import PROVIDER_SMOKE_CLOSURE_ASSETS, provider_smoke_closure_asset_paths
...
from .adapter_evidence import ADAPTER_EVIDENCE_ASSETS, adapter_evidence_asset_paths
...
OPTIONAL_CANONICAL_ASSETS = (
    ...
    *PROVIDER_SMOKE_CLOSURE_ASSETS.values(),
    LOCALE_CAPABILITY_REPORT_JSON,
    LOCALE_RISK_REPORT_JSON,
    LOCALE_READINESS_IMPACT_JSON,
    TRANSLATION_PROVENANCE_JSONL,
    ...
    *ADAPTER_EVIDENCE_ASSETS.values(),
    BLOCKING_QUESTIONS_JSON,
    RESOLUTION_OPTIONS_JSON,
    USER_RESOLUTION_DECISIONS_JSONL,
    RESOLUTION_SUMMARY_MD,
    ...
    try:
        ...
        manifest = {
            ...
            "assets": {
                ...
                **provider_smoke_closure_asset_paths(state_dir),
                ...
                **adapter_evidence_asset_paths(state_dir),
