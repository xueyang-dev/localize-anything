...
def build_work_packet(
    ...
    trimmed: list[str] = []
    packet = _packet(batch_plan, batch_id, selected, target_locale, context_sections, glossary, tm, hard_constraints, term_review, limit_tokens, trimmed, operating_mode, reference_policy)
