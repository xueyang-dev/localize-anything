...
EVIDENCE_FILES = {
    ...
    "provider_smoke_closure": "provider-smoke-closure-report.json",
    "provider_smoke_release_boundary": "provider-smoke-release-boundary-audit.json",
    "provider_smoke_evidence_manifest": "provider-smoke-evidence-manifest.json",
    "provider_smoke_remaining_blockers": "provider-smoke-remaining-blockers.json",
    "provider_smoke_next_step_decision": "provider-smoke-next-step-decision.json",
