...
2. Confirm target-v1 work, current implementation, legacy compatibility, and
   historical evidence are labeled accurately.
3. Merge release code into `main`.
4. Run unit tests, protocol validation, contract validation, `compileall`, and
