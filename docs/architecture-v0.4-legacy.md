# Legacy Architecture Snapshot (v0.4)

> Historical reference only. This document describes the platform-oriented
> architecture that existed before the 2026 product-direction reset. It is not
> the current product north star. See [Architecture](architecture.md) and
> [Product Direction](product-direction.md) for the active direction.
